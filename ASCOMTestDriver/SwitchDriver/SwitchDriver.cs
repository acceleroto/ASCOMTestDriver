...
//
// ASCOM Switch driver for AccelerotoSwitchTest
//
...
namespace ASCOM.AccelerotoSwitchTest.Switch
{
    //
    ...
    //
    // Your driver's DeviceID is ASCOM.AccelerotoSwitchTest.Switch
    //
    // The COM Guid attribute sets the CLSID for ASCOM.AccelerotoSwitchTest.Switch
    // The COM ClassInterface/None attribute prevents an empty interface called _AccelerotoSwitchTest from being created and used as the [default] interface
    //
    ...
    /// </summary>
    [ComVisible(true)]
    [Guid("7fed90d1-e613-42ae-bf9b-f288f35263fb")]
    [ProgId("ASCOM.AccelerotoSwitchTest.Switch")]
    [ServedClassName("ASCOM Switch Driver for AccelerotoSwitchTest")] // Driver description that appears in the Chooser, customise as required
    ...
    public class Switch : ReferenceCountedObjectBase, ISwitchV3, IDisposable
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AccelerotoSwitchTest"/> class. Must be public to successfully register for COM.
        /// </summary>
        public Switch()
        {
            try
            {
                ...
                tl = new TraceLogger("", "AccelerotoSwitchTest.Driver"); // Remove the leading ASCOM. from the ProgId because this will be added back by TraceLogger.
                SetTraceState();
            ...
            catch (Exception ex)
            {
                ...
                MessageBox.Show($"{ex.Message}", "Exception creating ASCOM.AccelerotoSwitchTest.Switch", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
